...
# *****************************************************************************
# This imports the webscraper.py script that I have written as scraper and does
# not run the test cases that can be found within that file.
# import webscraping as scraper -> To be Implemented in v0.0.3 Release
# *****************************************************************************
...
def get_userinfo():
    ...
    print()
    # Prompts the user to input whether or not the class only has one prof
    # teaching the weboptioned lectures. ie. prof teaches LEC01, 02... 0N,
    # N > 0
    one_section = input("One last request of Lemmy, does your class only" +
                        " have" +
                        " one weboptioned lecture section \nie. LEC01,LEC02," +
                        "etc. have the same prof teaching, \nwith access to" +
    ...
    return csrcode, crsetype, section, lecture, year, session
